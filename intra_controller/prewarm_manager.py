...
class PrewarmManager:
    def __init__(self, prewarm_limit, port_manager, package_counter):
        ...
        for _ in range(prewarm_limit):
            self.prewarm()
            # print('prewarm', _)
        self.function_path = '/home/ubuntu/Pagurus/interaction_controller/aws_actions/'
        self.virtualenv_path = '/home/ubuntu/Pagurus/intraaction_controller/virtualenv/'
...
class PackageCounter:
    def __init__(self):
        self.package_size_path = '/home/ubuntu/Pagurus/intraaction_controller/build_file/packages.json'
        self.build_limit = 4
...
class SockPrewarmManager:
    def __init__(self, prewarm_limit, port_manager, package_counter):
        ...
        self.function_path = '/home/ubuntu/Pagurus/interaction_controller/aws_actions/'
        self.virtualenv_path = '/home/ubuntu/Pagurus/intraaction_controller/virtualenv/'
        self.container_path = '/home/ubuntu/Pagurus/prewarm_container'
        self.package_counter = package_counter
