...
#controller = inter_controller(intra_url, '/home/ubuntu/Pagurus/interaction_controller/build_file/aws_packages.json')
if sys.argv[1] == 'aws':
    controller = inter_controller(intra_url, '/home/ubuntu/Pagurus/interaction_controller/build_file/aws_packages.json')
elif sys.argv[1] == 'azure':
    controller = inter_controller(intra_url, '/home/ubuntu/Pagurus/interaction_controller/build_file/azure_packages.json')
...
db_memory = "memory"
if db_memory in db_server:
    db_server.delete(db_memory)
db_M = db_server.create(db_memory)
...
def load_info():
   ...
   # node['net'] = (rxkB + txkB) / 1000 * 100
    ...
    db_M[str(Current_time)] = {'time': Current_time,'mem_used': mem_info.used, 'mem_total': mem_info.total,'mem_load': mem_load,'cpu_load': cpu_load}
    return ('memory, OK', 200)
