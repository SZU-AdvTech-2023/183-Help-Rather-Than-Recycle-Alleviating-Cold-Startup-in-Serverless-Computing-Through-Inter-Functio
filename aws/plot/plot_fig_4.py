...
data_prewarm = pd.read_csv('aws_result/e2e_latency.csv')
...
ax.axhline(y=0.68, color='tab:red', linestyle='--', linewidth=3)

ax.set_ylim(0, 1.8)
ax.set_yticks([0, 0.2, 0.4, 0.6, 0.68, 0.8, 1.0, 1.2, 1.4, 1.6, 1.8])
ax.set_yticklabels(["0", "0.2", "0.4", "0.6", "0.68", "0.8", "1.0", "1.2", "1.4", "1.6", "1.8"], fontsize=28)
...
plt.ylabel('平均端到端延迟/s', fontsize=28)
ax.legend(ncol=2, fontsize=24, loc='upper left', handlelength=1.5)
fig.savefig("aws_result/fig_4.pdf", bbox_inches='tight')
