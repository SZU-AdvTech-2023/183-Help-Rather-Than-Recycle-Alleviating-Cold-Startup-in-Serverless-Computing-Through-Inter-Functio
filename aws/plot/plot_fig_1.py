...
ax2.set_yticks([800, 1600, 2400, 3200])
ax2.set_yticklabels(["800","1600", "2400", "3200"], fontsize=28)

ax2.set_xticks(x)
ax2.set_xticklabels(['OpenWhisk(启用预热)', 'OpenWhisk(禁用预热)', 'Pagurus', 'SOCK'], fontsize=28, rotation = 0)

ax2.set_ylabel('冷启动次数',fontsize = 30)

plt.yticks(fontsize=28)
fig.legend(fontsize=30,ncol = 4,loc = 'upper center', bbox_to_anchor=(0.45, 1.07))

# plt.show()
fig.savefig("aws_result/fig_1.pdf",bbox_inches='tight')
